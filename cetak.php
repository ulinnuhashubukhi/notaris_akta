			...
			<div>
				<table width="100%" border="0">
					<tr>
						...
						<td align="left" width="450px;">
						<p align="justify" style="line-height: 8px;">Jaminan Fidusia serta surat-surat lain yang bersangkutan diserahkan kepada Penerima Fidusia.-----<br>
						---------------------------------------------------- <b>Pasal 2</b> -------------------------------------------<br>
			...
			<div>
				<table width="100%" border="0">
					<tr>
						...
						a. Obyek Jaminan Fidusia adalah milik/hak Pemberi Fidusia dan tidak ada orang/Pihak lain yang turut memiliki atau mempunyai hak apapun, oleh karena itu Pemberi Fidusia mempunyai kewenangan hukum untuk mengalihkan dan memindahkan hak atas Obyek Jaminan Fidusia; --------------------------------------------<br>
			...
			<div>
				<table width="100%" border="0">
					<tr>
						...
						<td align="left" width="450px;">
						<p align="justify" style="line-height: 7px;">- Pemberi Fidusia tidak berhak untuk melakukan fidusia ulang atas Obyek Jaminan Fidusia.------------<br>
			...
			<div>
				<table width="100%" border="0">
					<tr>
						...
						<td align="left" width="450px;">
						<p align="justify" style="line-height: 8px;">teguran juru sita atau surat lain yang serupa dengan itu. ------------------------------------------------<br>
						...
						---------------------------------------------------- <b>Pasal 9</b> -------------------------------------------<br>	 
						Pembebanan terhadap Obyek Jaminan Fidusia ini dilakukan oleh Pemberi Fidusia kepada Penerima Fidusia dengan syarat-syarat yang memutuskan (onder dee ontbindende voorwaarden), yakni sampai dengan Pemberi Fidusia telah memenuhi/membayar lunas semua yang wajib dibayar oleh Pemberi Fidusia kepada Penerima Fidusia sebagaimana ditentukan dalam perjanjian Pembiayaan.-------------------------------<br>
						---------------------------------------------------- <b>Pasal 10</b> -------------------------------------------<br>
						...
						- Selanjutnya menerima Sertifikat Jaminan Fidusia dan atau Pernyataan Perubahan, serta dokumen-dokumen lain yang berkaitan untuk keperluan itu, membayar semua biaya dan menerima kuitansi segala pembayaran serta 
						</p>
						</td>
			...
			<div>
				<table width="100%" border="0">
					<tr>
						...
						<td align="left" width="450px;">
						<p align="justify" style="line-height: 8px;">selanjutnya melakukan segala tindakan yang perlu dan berguna untuk melaksanakan ketentuan dari akta ini.--<br>
						...
						---------------------------------------------------- <b>Pasal 13</b> -------------------------------------------<br>
						- Segala perselisihan yang mungkin timbul diantara kedua belah pihak mengenai akta ini yang tidak dapat diselesaikan diantara kedua belah pihak sendiri, maka kedua belah pihak akan memilih domisili hukum yang tetap dan seumumnya di Kantor Panitera Pengadilan Negeri Jakarta Pusat. -------------------------------
			...
			<div>
				<table width="100%" border="0">
					<tr>
						...
						- Dibuat dan dilangsungkan di Karawang, pada hari, tanggal serta pada jam seperti disebutkan pada bagian awal akta ini, dengan dihadiri oleh: ----------------<br>
						...
						- Atas permintaan penghadap akta ini dibaca sendiri oleh penghadap dan penghadap menyatakan kepada saya, Notaris bahwa penghadap telah mengerti dan memahami tentang segala sesuatu yang termaktub dalam akta ini, maka
						</p>
						</td>
			...
			<div>
				<table width="100%" border="0">
					<tr>
						...
						<td align="left" width="450px;">
						<p align="justify" style="line-height: 8px;">seketika akta ini ditandatangani oleh penghadap, saksi-saksi dan saya, Notaris.--------------------------<br>
